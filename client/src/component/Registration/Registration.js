...
export default class Registration extends Component {
  ...
  updateVoterEpic = (event) => {
    this.setState({ voterEpic: event.target.value });
  };
  registerAsVoter = async () => {
    await this.state.ElectionInstance.methods
      .registerAsVoter(this.state.voterName, this.state.voterPhone, this.state.voterEpic)
            ...
            <div className="container-main">
              ...
              <div className="container-item">
                <form>
                  ...
                  <div className="div-li">
                    <label className={"label-r"}>
                      Voter ID Card Number <span style={{ color: "tomato" }}>*</span>
                      <input
                        className={"input-r"}
                        type="text"
                        placeholder="eg. AFD3421908"
                        value={this.state.voterEpic}
                        onChange={this.updateVoterEpic}
                      />
                    </label>
                  </div>
                  <p className="note">
                  ...
                  <button
                    className="btn-add"
                    disabled={
                      this.state.voterPhone.length !== 12 || this.state.voterEpic.length!=10 ||
