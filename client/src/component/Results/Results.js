...
function displayWinner(candidates) {
  ...
  const renderWinner = (winner) => {
    const pa=`images/${winner.slogan}.png`;
    return (
      <div className="container-winner">
        <div className="winner-info">
          ...
          <img id="party" src={pa} alt="party Logo" height="35px" width="35px"/>
        </div>
...
export function displayResults(candidates) {
  const renderResults = (candidate) => {
    const pa=`images/${candidate.slogan}.png`;
    const sno=`${parseInt(candidate.id)+1}`;
    return (
      <tr>
        <td>{sno}</td>
        <td><img id="party" src={pa} alt="party Logo" height="35px" width="35px"/></td>
